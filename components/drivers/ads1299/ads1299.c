...
ADS1299_ReturnType ADS1299_Init(void)
{
   ...
   ADS1299_ConfigBiasSensP(0, \
	...
	// ADS1299_ConfigChannelSettings(0, 0, ADS1299_RESET, ADS1299_GAIN24, ADS1299_INPUT_NORMAL, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 1, ADS1299_RESET, ADS1299_GAIN24, ADS1299_INPUT_NORMAL, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 2, ADS1299_RESET, ADS1299_GAIN24, ADS1299_INPUT_NORMAL, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 3, ADS1299_RESET, ADS1299_GAIN24, ADS1299_INPUT_NORMAL, ADS1299_RESET);

	// ADS1299_ConfigChannelSettings(0, 0, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 1, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 2, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 3, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);

	// ADS1299_ConfigChannelSettings(0, 4, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 5, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 6, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);
	// ADS1299_ConfigChannelSettings(0, 7, ADS1299_SET, 0x07U, ADS1299_INPUT_SHORTED, ADS1299_RESET);
